...
class App extends Component {
  ...
  loadMore = () => {
    ...
    let proxyUrl = "https://cors-anywhere.herokuapp.com/",
      targetUrl = `http://pokeapi.co/api/v2/pokemon/?limit=${limits}&offset=12.`;
    axios.get(proxyUrl + targetUrl).then((res) => {
      this.setState({
  ...
  render() {
    ...
    const pokemonList = pokemons.length ? (
      ...
      <div className="falseRequest">
        <IosRefresh fontSize="30px" color="rgb(255, 2, 2)" rotate={true} />{" "}
        Loading pokemons ...
      </div>
    );
      ...
      <div className="App">
        ...
        <div className="main-wrapper">
          <div className="pokemonList">
            {pokemonList}
            <div onClick={this.loadMore} className="load-more" href="#">
              Load More
            </div>
          </div>
